...
public:
    ...
    status_t attachToContext(GLuint tex);
		...
		//2012-09-21 Byungil-Choi(byungil.choi@lge.com) [gk/VideoNewFeature]VideoZoom[START]
#if defined (LIVE_ZOOMING) || defined (FINGER_TIP_SEEK)
    status_t setCropForPlayer(const Rect &rect);
#endif
		//2012-09-21 Byungil-Choi(byungil.choi@lge.com) [gk/VideoNewFeature]VideoZoom[END]
protected:
