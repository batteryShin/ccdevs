...
public:
    ...
    virtual status_t setDestMargin(float leftMargin, float topMargin, float rightMargin, float bottomMargin){ return INVALID_OPERATION; }
    virtual status_t enableOpenGLRendering(int enable){ return INVALID_OPERATION; }
    virtual status_t setCropForPlayer(const Rect &rect){ return INVALID_OPERATION; }
    bool isEmpty() const;
#endif
