...
// LGE_CHANGE_S, [JB+][G2_MM][byungil.choi@lge.com], 2013-04-15 , Screen recorder [start]
#if defined(SCREEN_RECORDER)
    static void setDisplayForcedRefresh(const sp<IBinder>& token);
#endif
// LGE_CHANGE_S, [JB+][G2_MM][byungil.choi@lge.com], 2013-04-15 , Screen recorder [end]
