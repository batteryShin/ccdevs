...
#ifdef CAPP_FONTS
    static void SelectDefaultTypeface( uint32_t fontIndex );
    static SkTypeface * GetDefaultTypeface();
    static void UpdateDownloadFonts();
    static void UpdateDefaulTypeface();
    static uint32_t GetDefaultTypefaceIndex();
    static uint32_t GetNumAllFonts();
    static uint32_t GetNumEmbeddedFonts();
    static const char * GetDownloadFontName( uint32_t fontIndex );
    static const char * GetFontWebFaceName( uint32_t fontIndex );
    static const char * GetFontFullPath( uint32_t fontIndex );
    static const char * GetDownloadFontSrcPath();
    static const char * GetDownloadFontDstPath();
    static uint32_t GetSystemDefaultTypefaceIndex();
    static uint32_t UpdateFontManager();
    static uint32_t GetNumNewFonts();
    static const char * GetNewFontAppName( uint32_t fontIndex );
    static uint32_t GetCheckNewFont( uint32_t fontIndex );
    static bool AddNewFont( uint32_t fontIndex );
    static void SaveNewFont();
#endif
