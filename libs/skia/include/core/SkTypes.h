...
#ifdef CAPP_FONTS
#ifndef HyLogif
#define HyLogif(...) HyDebugif( __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__ )
void HyDebugif( const char * file, int line, const char * func, const char * format, ... );
#endif

#ifndef HyLogef
#define HyLogef(...) HyDebugef( __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__ )
void HyDebugef( const char * file, int line, const char * func, const char * format, ... );
#endif

#ifndef HyLogi
#define HyLogi(...) HyLogf( __VA_ARGS__ )
void HyLogf( const char * format, ... );
#endif
#endif
